  ...
  <div className="flex min-w-0 flex-col space-y-2">
    ...
    <div className="relative min-w-0">
      <input
        ...
        onChange={onChange}
        placeholder="0"
        className="w-full rounded-md border px-3 py-2 pr-12 focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
    ...
    <main className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="mb-8 text-center md:text-left">
          <p className="text-slate-600 text-sm font-medium max-w-3xl mx-auto md:mx-0">
            月次の固定費と元本返済を粗利で賄うために、必要な売上・数量・値上げを整理します。
            <Link
              href="/"
              className="ml-1 text-blue-700 font-bold underline decoration-blue-200 underline-offset-2 hover:text-blue-900"
            >
              値上げ×資金繰りシミュレーター
            </Link>
            とは独立した簡易モデルです。
            ...
            {!outcome.ok ? (
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 text-xs text-slate-600 font-medium leading-relaxed">
                  ...
                  内訳: 固定費 {formatYen(numericInputs.fixedCosts)} ＋ 元本返済{' '}
          ...
          <div className="bg-white p-5 md:p-10 rounded-3xl border border-blue-100 shadow-sm mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl border border-slate-200 p-6 bg-gradient-to-br from-blue-600 to-blue-800 text-white shadow-lg">
                ...
                <p className="text-xs text-blue-100 font-bold mt-1 mb-4">
                  不足の50%ずつを数量・値上げで分担
                </p>
